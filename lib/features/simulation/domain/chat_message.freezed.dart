...
mixin _$ChatMessage {
 ...
 ChatRole get role; String get content; DateTime get timestamp;/// True while assistant text is still arriving token-by-token; drives the
...
@useResult
$Res call({
 ChatRole role, String content, DateTime timestamp, bool isStreaming
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( ChatRole role,  String content,  DateTime timestamp,  bool isStreaming)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ChatMessage() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( ChatRole role,  String content,  DateTime timestamp,  bool isStreaming)  $default,) {final _that = this;
switch (_that) {
case _ChatMessage():
return $default(_that.role,_that.content,_that.timestamp,_that.isStreaming);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( ChatRole role,  String content,  DateTime timestamp,  bool isStreaming)?  $default,) {final _that = this;
switch (_that) {
case _ChatMessage() when $default != null:
return $default(_that.role,_that.content,_that.timestamp,_that.isStreaming);case _:
  return null;
...
class _ChatMessage implements ChatMessage {
  const _ChatMessage({required this.role, required this.content, required this.timestamp, this.isStreaming = false});
